...
const PREMADE_REVIEWS = [
  "Delivery is fast but they forgot my fresh coriander. Refund took 3 hours! Please improve customer support.",
  "Blinkit makes it so easy to try new snacks! I discovered this local chip brand. Will buy again.",
  "I wanted to order batteries, but the search kept showing me charging cables. The app is confusing."
];
...
Only return JSON. No markdown backticks.`;
  ...
  return (
    <div className="glass mb-3" style={{ padding: '1.5rem', marginBottom: '1.5rem' }}>
        ...
        <div style={{ marginTop: '1.25rem', paddingTop: '1.25rem', borderTop: '1px solid var(--border-glass)' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem', marginBottom: '1.25rem' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', opacity: stage >= 2 ? 1 : 0.4 }}>
              ...
              <span style={{ fontSize: '0.8rem', color: stage === 2 ? 'var(--accent-yellow)' : 'var(--text-primary)' }}>2. Gemini 3.1 LLM Batch Classification (Tagging Sentiment & Taxonomy)</span>
            </div>
          </div>
