...
import { Database, Layers, Sparkles, Settings, BarChart3, ArrowRight } from 'lucide-react';
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '1.25rem', width: '100%' }}>
        ...
        <div style={{ flex: '1 1 200px' }}>
          ...
          <p style={{ margin: '0.25rem 0 0 0', color: 'var(--text-secondary)', fontSize: '0.75rem', lineHeight: '1.4' }}>
            Reddit/Twitter (via Apify) & Play Store reviews mapped to LLM synthesis.
          </p>
        </div>
        ...
        <div style={{ flex: '3 1 650px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '0.5rem', flexWrap: 'nowrap', overflowX: 'auto', paddingBottom: '4px' }}>
          ...
          <div style={{ 
            ...
            <div style={{ textAlign: 'left' }}>
              ...
              <div style={{ fontSize: '0.65rem', color: 'rgba(255, 255, 255, 0.7)', marginTop: '1px' }}>Apify & Scrapers</div>
            </div>
          </div>
          ...
          <div style={{ 
            ...
            <div style={{ textAlign: 'left' }}>
              ...
              <div style={{ fontSize: '0.65rem', color: 'rgba(255, 255, 255, 0.7)', marginTop: '1px' }}>Pandas Filter</div>
            </div>
          </div>
          ...
          <div style={{ 
            ...
            <div style={{ textAlign: 'left' }}>
              ...
              <div style={{ fontSize: '0.65rem', color: 'rgba(255, 255, 255, 0.7)', marginTop: '1px' }}>100-batch Classify</div>
            </div>
          </div>
          ...
          <div style={{ 
            ...
            <div style={{ textAlign: 'left' }}>
              ...
              <div style={{ fontSize: '0.65rem', color: 'rgba(255, 255, 255, 0.7)', marginTop: '1px' }}>Human-in-the-loop</div>
            </div>
          </div>
          ...
          <div style={{ 
            ...
            <div style={{ textAlign: 'left' }}>
              ...
              <div style={{ fontSize: '0.65rem', color: 'rgba(255, 255, 255, 0.7)', marginTop: '1px' }}>React Charts</div>
            </div>
          </div>
